                    ...
                    <div className="row" >
                        ...
                        <div className="col-lg-6" style={{ display: "flex", justifyContent: "center", alignItems: "center", padding: "20px" }}>
                            ...
                            >
                                ...
                                <input type="text" name="name" placeholder="What's Your Good Name"></input>
                                <label htmlFor="email" className="mb-2">Your Email</label>
                                <input type="email" name="email" placeholder="What's Your Email"></input>
                                <label htmlFor="message" className="mb-2">Message</label>
                                <textarea rows="4" cols="50" name="message" placeholder="Type Your Message here!"></textarea>
